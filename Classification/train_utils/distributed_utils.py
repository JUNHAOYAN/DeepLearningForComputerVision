...
class SmoothedValue(object):
    ...
    用于记录数据，可通过window_size调整记录数据的大小，同时fmt调整print输出的格式
    “{mediam:.4f}, {avg:.4f}, {global_avg:.4f}, {max:.4f}, {value:.4f}”
    """
...
class MetricLogger(object):
    """
    封装多个SmoothedValue类，然后输出到命令行。
    使用self.log_every(iterable, print_freq, header=None): generator类
    可输出数据采集时间，每一个iter时间等信息
    """
